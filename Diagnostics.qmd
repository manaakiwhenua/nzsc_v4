...
Ironstone-pans are not usually associated with eluvial horizons and do not occur in [Podzols](key-to-orders.qmd#sec-ord-Z). They differ from [ortstein-pans](#sec-diag-opan) and [placic horizons](#sec-diag-plac) which are often associated with eluvial horizons in [Podzols](key-to-orders.qmd#sec-ord-Z) or [Brown Soils](key-to-orders.qmd#sec-ord-B), and which have high organic carbon levels. Ironstone pans meet the requirements of the material below a petroferric contact of Soil Taxonomy [@soilsurveystaff1999].
