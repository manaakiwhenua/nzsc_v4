# Diagnostic horizons and other differentiae {#diagnostics .unnumbered}
...
## Allophanic Soil Material {#diag-alloph .unnumbered}
...
## Argillic Horizon {#diag-argh .unnumbered}
...
## Brittle-B Horizon {#diag-britb .unnumbered}
...
## Calcareous Horizon {#diag-calch .unnumbered}
...
## Crumb Structure {#diag-crumb .unnumbered}
...
## Cutanic Horizon {#diag-cuth .unnumbered}
...
## Distinct Topsoil {#diag-dts .unnumbered}

A distinct topsoil (modified from @avery_soil_1980) is normally designated an A horizon and has **BOTH** of the following:
...
## Duripan {#diag-dpan .unnumbered}

A duripan is a subsurface horizon that is cemented by silica or other opaque or uncoloured material. It has **ALL** of the following requirements, but does **not** meet the requirements of the [calcareous horizon](#diag-calch):
...
## Fluvial Features {#diag-fluv .unnumbered}
...
## Gley Profile Form {#diag-gleypf .unnumbered}
...
## Humus-Pan {#diag-hpan .unnumbered}
...
## Ironstone-Pan {#diag-ipan .unnumbered}
...
## Lithic Contact {#diag-lithc .unnumbered}
...
*In situ* rocks in New Zealand are commonly jointed at intervals of less than 100 mm, and consequently the lithic contact definition of Soil Taxonomy [@soil_survey_staff_soil_1999] often fails to apply [@laffan_comment_1979]. The lithic contact is defined here as follows:
...
## Mottled Profile Form {#diag-mottpf .unnumbered}

A mottled profile form is defined by **EITHER**

1.  A [redox-mottled horizon](#diag-roxh) with an upper boundary within 15 cm of the base of the A horizon, or within 30 cm of the mineral soil surface; **OR**
...
## Nodular Horizon {#diag-nodh .unnumbered}
...
## Organic Soil Material {#diag-org .unnumbered}
...
## Ortstein-Pan {#diag-opan .unnumbered}
...
## Oxidic Horizon {#diag-oxh .unnumbered}
...
3.  Primary peds slake rapidly in water to stable microaggregates which show no dispersion or slight dispersion after 100 inversions using the method of @mcqueen_new_1981; **AND**
4.  Non-reactive or very weakly reactive to the reactive-aluminium test [@fieldes_rapid_1966]. Oxidic horizons are clayey, with measured clay contents commonly exceeding 60%. The measured clay percentage is usually larger than in overlying A horizons, but clay increase is not a defining criterion because of the problem of quantifying clay contents in materials that are frequently difficult to disperse.
...
## Paralithic Contact {#diag-plith .unnumbered}
...
## Peaty Topsoil {#diag-pts .unnumbered}
...
## Perch-Gley Features {#diag-pgley .unnumbered}
...
## Placic Horizon {#diag-plac .unnumbered}
...
## Podzolic-B Horizon {#diag-podzb .unnumbered}
...
## Reactive-Aluminium Test {#diag-naf .unnumbered}
...
## Redox-Mottled Horizon {#diag-roxh .unnumbered}
...
## Redox Segregations {#diag-rsegs .unnumbered}
...
## Reductimorphic Horizon {#diag-redmh .unnumbered}
...
## Slowly Permeable Layer {#diag-slowp .unnumbered}
...
## Sodic Features {#diag-sod .unnumbered}
...
## Tephric Soil Material {#diag-teph .unnumbered}
...
## Vitric Soil Material {#diag-vitr .unnumbered}
...
## Weathered-B Horizon {#diag-bw .unnumbered}
