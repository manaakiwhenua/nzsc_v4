...
t2 <- data.frame(
  'col1' = c('Horizons, Pans and\n Layers:', 'Argillic horizon', 'Brittle-B horizon',
             ...
             'Duripan', 'Distinct topsoil', 'Eluvial horizon', 'Fragipan', 'Humus-pan', 'Ironstone-pan', 
  ...
  'col2' = c('Soil materials and\n Contacts:', 'Allophanic soil material', 
             'Anthropic soil material', 'Lithic contact', 'Organic soil material',
             'Paralithic contact', 'Tephric soil material', 'Vitric soil material', 
             '', 'Profile Forms:', 'Gley profile form', 'Mottled profile form',
