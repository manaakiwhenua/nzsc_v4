...
| [Distinct topsoil](#sec-diag-dts) | Sulfidic soil material |
| [Duripan](#sec-diag-dpan) | Sulfuric soil material |
| [[Eluvial horizon](#sec-diag-eluvh)]{.maj} | [Tephric soil material](#sec-diag-teph) |
...
Allophanic soil material has soil properties dominated by nanocrystalline minerals (structured at the nanometre scale, previously termed short-range order), namely allophane and ferrihydrite. Imogolite, which comprises long, thin hollow nanotubes, and thus has both long- and short-range order, may occur with allophane but usually in small amounts. Other terms such as "amorphous", "poorly crystalline" and "non-crystalline", have been previously used for such minerals but in most cases are no longer valid (). Their chief characteristics are reactive variable-charge surfaces, and a very high specific surface area (several hundreds of m^2^/g).
...
## Low-chroma colours  {#sec-diag-lch}
