...
A fragipan is an apparently non-cemented horizon that has high bulk density (usually ≥ 1.5 Mg/m^3^) with high strength when dry. It is given the horizon notation suffix x (e.g. Bwx, BCx). It has **ALL** of the following:
