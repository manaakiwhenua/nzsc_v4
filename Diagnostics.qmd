...
A densipan is a non-cemented E horizon, denoted with the suffix d (e.g. Ed), of very high soil strength and bulk density. It meets the requirements of an [eluvial horizon](#sec-diag-eluvh) and **BOTH** of the following:
...
The duripan is recognised in [Pallic Soils](key-to-orders.qmd#sec-ord-P) where the cementing materials are apparently related to the presence of siliceous tephra in the parent material or high exchangeable sodium in the soil. A duripan is given the horizon notation suffix q (e.g. Bq).
...
A fragipan is an apparently non-cemented subsoil horizon that has high bulk density (usually ≥ 1.5 Mg/m^3^) with high strength when dry. It is given the horizon notation suffix x (e.g. Bwx, BCx). It has **ALL** of the following:
...
A nodular horizon has more than 15% (by volume) nodules, as segregations of iron or aluminium oxyhydroxides, with some kaolinite, in a layer more than 10 cm thick. Nodular horizons are given the horizon notation suffix i (e.g. Boi, BCi).
...
The oxidic horizon is a strongly weathered B horizon consisting of mixed crystalline iron and aluminium oxides and kaolin group minerals, with low activity clay properties. An oxidic horizon is given the notation suffix o (e.g. Bo). It has **ALL** the following requirements:
...
A horizon with sodic features has significant exchangeable sodium. This is not necessarily related to a high soluble salt content. A sodic horizon is given the notation suffix n (e.g. Btn, BCn). It has **BOTH**
...
1.  Tephra --- unconsolidated, primary pyroclastic products of volcanic eruptions [@froggatt1990] such as ash, cinders, lapilli, pumice, scoria, blocks, or volcanic bombs, and
