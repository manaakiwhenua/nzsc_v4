...
::: min
Other Brown Soils that from the base of the A horizon to 60 cm from the mineral soil surface, have sand or loamy sand texture and less than 35% gravel (by volume), in all horizons (except for sandy loam laminations that do not meet the requirements of an [argillic horizon](Diagnostics.qmd#sec-diag-argh)).
:::
...
1.  in the B or BC horizon to 90 cm or less from the mineral soil surface the majority of the coarse rock fragments is weathered to the extent that coarse rock fragments may easily be broken by hammer or spade, and
...
Other soils in which the majority of the gravel is weathered to the extent that [rock fragments]{.min} may easily be broken by hammer or spade.
...
1.  a [mottled profile form](Diagnostics.qmd#sec-diag-mottpf) [or [perch-gley features](Diagnostics.qmd#sec-diag-pgley).]{.maj}, *and*
2.  gravel that in the majority is weathered to the extent that [rock fragments]{.min} may easily be broken by hammer or spade.
...
1.  gravel that in the majority is weathered to the extent that [rock fragments]{.min} may easily be broken by hammer or spade.
2.  a pH of less than 5.5 within 60 cm of the mineral soil surface in some part of the B or BC horizon.
