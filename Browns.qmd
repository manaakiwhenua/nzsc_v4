...
Other soils that have, in some part[^browns-1] of the B [or BC]{.min} horizon to 60 cm from the mineral soil surface, **both**
...
2.  *either*
    ...
    (b) have an exchangeable calcium/magnesium ratio of 0.2 or less in some part of the B [or BC]{.min} horizon to 60 cm from the mineral soil surface.
...
2.  have an exchangeable calcium/magnesium ratio of 0.2 or less in some part of the B [or BC]{.min} horizon to 60 cm from the mineral soil surface.
...
2.  a [mottled](Diagnostics.qmd#sec-diag-mottpf) or [[perch-gley features](Diagnostics.qmd#sec-diag-pgley).]{.maj}.
...
1.  a [mottled profile form](Diagnostics.qmd#sec-diag-mottpf) [or [perch-gley features](Diagnostics.qmd#sec-diag-pgley).]{.maj}, *and*
2.  gravel that in the majority is weathered to the extent that [coarse rock fragment]{.min} may easily be broken by hammer or spade.
...
Other soils in which the majority of the gravel is weathered to the extent that [coarse rock fragments]{.min} may easily be broken by hammer or spade.
...
1.  a [mottled profile form](Diagnostics.qmd#sec-diag-mottpf) [or [perch-gley features](Diagnostics.qmd#sec-diag-pgley).]{.min}, *and*
...
Other soils with gravel that in the majority is weathered to the extent that [coarse rock fragments]{.min} may easily be broken by hammer or spade.
