...
Oxidic Soils are only known to occur in Northland, where they can be associated with boulder fields of mafic volcanic rock, and the progression of rock weathering is impeded by oxide coatings.

## Accessory Properties of the Order {#sec-acc-X}

1.  *Low-activity clay.* CEC is low at field pH. ECEC is less than 12 cmol~c~/kg (clay), and CEC less than 16 cmol~c~/kg (clay). The soils are weakly buffered. Some subhorizons have a net positive charge. Oxidic Soils usually have the following mineralogy classes: Kandic, Ferritic or Aluminitic/Gibbsitic.
...
4.  *Limited rooting depth.* The extension of plant roots is limited by high dry bulk density and high penetration resistance, particularly in well-drained soils. Aluminium toxicity at depth can also be a limiting factor. Plant root depths are shallow to medium.
...
10. *Strongly weathered with very low nutrient reserves.* The soils have very low reserves of potassium, magnesium, calcium, and phosphorus. Despite a strongly weathered fine-earth fraction, rock fragments that are no more than moderately weathered may still occur.
...
1.  A decrease in clay content with depth of more than 20% relative to that of the horizon with maximum clay; OR
2.  More than 5% coarse rock fragments or a [lithic](Diagnostics.qmd#sec-diag-lithc) or [paralithic contact](Diagnostics.qmd#sec-diag-plith).
