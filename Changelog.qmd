...
-   **AMEND** [Mottled Profile Form](Diagnostics.qmd#sec-diag-mottpf) to exclude \*(f) horizons from its definition.\
    **Rationale:** Resolves a discrepancy where profiles that had some redox mottling but no gleying were inappropriately classified into the Mottled subgroup. Mottled subgroup soils should have at least one imperfectly drained horizon starting within 30 cm of the surface, or at least one poorly drained horizon within 60 cm.
...
-   **RECODE** PJU ([Ultic Argillic Pallic Soils](Pallics.qmd#sec-key-PJY)) to PJY
