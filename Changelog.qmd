...
-   **REPLACE** references to E horizons with cross-references to the [Eluvial horizon](Diagnostics.qmd#sec-diag-eluvh) diagnostic.
-   **REPLACE** references to salinity cutoffs with cross-references to the [Saline soil materials](Diagnostics.qmd#sec-diag-salt) diagnostic.
