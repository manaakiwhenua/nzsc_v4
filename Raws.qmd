...
2.  *Fresh or weakly weathered.* [Rock fragments]{.min} and sand particles are generally without coatings, although [rock fragments]{.min} in some screes may have weathering rinds.
...
table_W_dat <- data.frame(
  'Code' = c('WW', 'WG', rep('', 6), 'WH', 'WX', 'WS', 'WF', 'WT', 'WO'),
  'Group' = c('Hydric', 'Gley', rep('', 6), 'Hydrothermal', 'Rocky', 'Sandy',
...
[Other]{.min} Raw Soils that at 30 cm or less from the mineral soil surface have either
...
Other Raw Soils that have sand or loamy sand texture and that have less than 35% [rock fragments]{.min} (by volume) in all horizons, from the soil surface to 60 cm depth or more.
...
Other soils that have sand or loamy sand texture and that have less than 35% [rock fragments]{.min} (by volume) in all horizons, from the soil surface to 60 cm depth or more.
...
Hydrothermal Raw Soils occur in active hydrothermal areas affected by hot [liquids or steam]{.min}.
