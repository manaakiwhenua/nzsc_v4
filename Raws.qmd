...
Raw Soils correspond in part with very weakly developed recent soils of the *New Zealand Genetic Soil Classification*, and in part with materials that were often not considered to be soil. They are mostly Entisols or are unclassified in *Soil Taxonomy*.
...
2.  *Fresh or weakly weathered.* Coarse rock fragments and sand particles are generally without coatings, although rock fragments in some screes may have weathering rinds.
...
4.  *High water-table.* In soils with a fluid subsurface layer a continuously high water-table is present. The deposition of fresh sediment may occur.
5.  *Non-fluid soils.* These occur in environments with active erosion or deposition.
6.  *Low fertility.* Nitrogen in particular, is deficient.
7.  *Erosive.* Most materials are non-cohesive and likely to be highly erosive.
...
1.  Have the upper boundary of a [reductimorphic horizon](Diagnostics.qmd#sec-diag-redmh); OR
2.  Have sufficient active ferrous iron to give a positive reaction to [Childs' test](Diagnostics.qmd#sec-diag-fe2) at some time in the year; OR
...
Other Raw Soils in predominantly gravel-sized mafic or intermediate [tephric soil material](Diagnostics.qmd#sec-diag-teph) (basaltic, andesitic) from the soil surface to 30 cm depth or more.
...
Hydric Raw Soils have surface water present for a majority of the time, but not permanently. They are commonly part of active riverbeds or other shore environments (coastal, lacustrine).
...
Gley Raw Soils occur in sites that are periodically flooded. Wetness is expressed in the soil by [low-chroma colours](Diagnostics.qmd#sec-diag-lch) with brownish or reddish mottles, by water saturation, or is indicated by the presence of reduced iron ([Childs' test](Diagnostics.qmd#sec-diag-fe2)).
...
1.  A moderately fluid or very fluid fluidity class at a depth of 30 cm or less; AND
2.  [Sulfidic soil material](Diagnostics.qmd#sec-diag-sulfd) present in some part within 90 cm of the mineral soil surface.
...
### **WH** - Hyderothermal Raw Soils {#sec-WH .unnumbered}

Hydrothermal Raw Soils occur in active hydrothermal areas affected by hot liquids or steam.

No subgroups have been defined.

### **WC** - Cryic Raw Soils {#sec-WC .unnumbered}

Cryic Raw Soils likely occur (data deficient, see @tbl-nzscstareas) in alpine locations above c. 2,000 m elevation, particularly near glaciers.
