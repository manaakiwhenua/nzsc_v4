...
The order comprises gley soils and gleyed recent soils of the NZ Genetic Soil Classification. The soils correlate predominantly with [soils exhibiting aquic conditions in Soil Taxonomy, particularly the suborders Aquents, Aquepts, Aquults, and Aquox.]{.min}
...
Other Gley Soils that have a sand or loamy sand texture, and less than 35% (by volume) [rock fragments]{.min}, in all horizons from the base of the A horizon to 60 cm from the mineral soil surface.
...
2.  have none of the following:
    ...
    (c) [a [placic horizon](Diagnostics.qmd#sec-diag-plac) nor [ortstein-pan](Diagnostics.qmd#sec-diag-opan) , *nor*]{.min}
...
2.  [[saline soil materials](Diagnostics.qmd#sec-diag-salt).]{.min}
...
Other soils that are sandy by weighted average to 90 cm from the mineral soil surface and have [[saline soil materials](Diagnostics.qmd#sec-diag-salt)]{.min} within 60 cm of the mineral soil surface.
...
Tephric Gley Soils that have a [peaty topsoil](Diagnostics.qmd#sec-diag-pts) either at the surface or buried with its upper surface within 60 cm of the soil surface.
...
Other soils that within 60 cm of the mineral soil surface have [[saline soil materials](Diagnostics.qmd#sec-diag-salt).]{.min}
...
Other soils that have both a [placic horizon](Diagnostics.qmd#sec-diag-plac) and a B horizon with 10% or more dark-coloured coats on ped faces, in pores or on [rock fragments]{.min}, with moist colour value 4 or less or colour value 5 and chroma 3.
...
Other soils that have a B horizon with 10% or more dark-coloured coats on ped faces, in pores or on [rock fragments]{.min}, with moist colour value 4 or less or colour value 5 and chroma 3.
...
Orthic Gley Soils occur on relatively stable land surfaces in sites affected by groundwater. Sediment deposition is unlikely if flooding occurs. They are neither strongly [acidic]{.min}, sandy nor sulphuric and have no [oxidic horizon](Diagnostics.qmd#sec-diag-oxh).
...
Other soils that have an [[ironstone-pan](Diagnostics.html#sec-diag-ipan)]{.min} at 90 cm depth or less from the mineral soil surface.
...
2.  is [moderately]{.min} sticky or very sticky, *and*
