...
## The Soil Individual {#intro-soil-indiv .unnumbered}
...
## How to assign a soil to Subgroup level {#intro-assign-subgroup .unnumbered}
...
```{r}
#| label: f1
#| fig.cap: "The hierarchy of the [Oxidic Soils](\\#ord-X) as an example of the hierarchical relationships between orders, groups and subgroups. As the diagram suggests, the range of soil properties for each class is related to hierarchical position."

knitr::include_graphics('images/Figure-001_oxidic-soils-hierarchy.png')
```

## Misclassification {.unnumbered}
...
## Justification of new Subgroups {#intro-new-sgs .unnumbered}
...
## Correlations with other soil classification systems {#intro-correls .unnumbered}
