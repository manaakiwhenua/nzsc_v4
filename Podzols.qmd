...
1.  an [[Eluvial horizon](Diagnostics.qmd#sec-diag-eluv)]{.min} with either the greyish colours of a [reductimorphic horizon](Diagnostics.qmd#sec-diag-redmh), a [peaty topsoil](Diagnostics.qmd#sec-diag-pts), or a [placic horizon](Diagnostics.qmd#diag-plac) together with [redox-segregations](Diagnostics.qmd#sec-diag-rsegs) in the [[Eluvial horizon](Diagnostics.qmd#sec-diag-eluv)]{.min}, *and*
