...
1.  an [[Eluvial horizon](Diagnostics.qmd#sec-diag-eluv)]{.maj} with either the greyish colours of a [reductimorphic horizon](Diagnostics.qmd#sec-diag-redmh), a [peaty topsoil](Diagnostics.qmd#sec-diag-pts), or a [placic horizon](Diagnostics.qmd#diag-plac) together with [redox-segregations](Diagnostics.qmd#sec-diag-rsegs) in the [[Eluvial horizon](Diagnostics.qmd#sec-diag-eluv)]{.maj}, *and*
...
1.  either an [[Eluvial horizon](Diagnostics.qmd#sec-diag-eluv)]{.maj} with the greyish colours of a [reductimorphic horizon](Diagnostics.qmd#sec-diag-redmh) or a [peaty topsoil](Diagnostics.qmd#sec-diag-pts), *and*
...
Densipan Podzols have a high density but uncemented pan within the [[Eluvial horizon](Diagnostics.qmd#sec-diag-eluv)]{.maj} at shallow depths which severely limits root penetration and water movement.
...
1.  an [[Eluvial horizon](Diagnostics.qmd#sec-diag-eluv)]{.maj} that
...
Other soils that have an [[Eluvial horizon](Diagnostics.qmd#sec-diag-eluv)]{.maj} that has slightly firm or greater moist soil strength, is apedal massive or has very coarse to extremely coarse prismatic pedality, and occurs within a layer that is silty through a thickness of at least 15 cm.
