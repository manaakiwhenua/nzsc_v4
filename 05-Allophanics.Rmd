...
## Summary of Allophanic Soils Hierarchy {-#sum-A}
...
ft <- flextable(table_A)
ft <- bold(ft, part = 'head')
ft <- merge_v(ft, 1)
ft <- merge_v(ft, 2)
ft <- valign(ft, j = c(1,2), valign = 'top')
ft <- bold(ft, j = 1)
...
## Key to Groups of Allophanic Soils {-#grp-A}
...
## Key to Subgroups of Allophanic Soils {-#sub-A}
