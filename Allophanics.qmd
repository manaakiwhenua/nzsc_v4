...
The order comprises mainly yellow-brown loams but also includes weakly weathered red loams and brown loams and some upland and high country yellow-brown earths of the NZ Genetic Soil Classification. The soils correlate predominantly with the [Andisols]{.min} of Soil Taxonomy.
...
Orthic Allophanic Soils are permeable soils without barriers to deep penetration of roots. They are [well, moderately well,]{.min} or imperfectly drained.
...
Other soils that have both 1. ***either*** (a) coatings on pores (excluding root linings), or gel-like masses bridging sand grains or coating coarse-fragments, that have hue 7.5YR or redder, value 5 or less and chroma 3 or more, *or* (b) pH less than 5.5 in some part of the B [or BC]{.min} horizon to 60 cm from the mineral soil surface, *and* 2. [allophanic soil material](Diagnostics.qmd#sec-diag-alloph) that is formed predominantly from [tephric soil material](Diagnostics.qmd#sec-diag-teph) and has 50% or more sand (by weighted average).
...
Other soils that have, in some part of the B [or BC]{.min} horizon to 60 cm from the mineral soil surface, *either*
