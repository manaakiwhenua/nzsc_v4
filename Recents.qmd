...
Recent soils occur throughout New Zealand in young landscapes, including alluvial floodplains, unstable steep slopes and slopes [covered]{.min} by young volcanic ash.
...
3.  *[Rock fragments]{.min} or rock is not strongly altered.* The alteration status of [rock fragments]{.min} or rock usually ranges from fresh to moderately weathered.
...
table_R_dat <- data.frame(
  ...
  'Group' = c('Hydrothermal',
              ...
              'Orthic', rep('', 5)),
  'Subgroup' = c('Inactive',
                 'Peaty-acidic', 'Mottled-acidic', 'Mottled', 'Acidic', 'Typic',
...
Other Recent Soils that are have sand or loamy sand texture and have less than 35% (by volume) [rock fragments]{.min}, in all horizons between the base of the A horizon and 60 cm from the mineral soil surface. Lamellae of sandy loam (of insufficient thickness to meet the requirements of an argillic horizon) may be present.
...
Other Recent Soils in [tephric soil material](Diagnostics.qmd#sec-diag-teph) from the mineral soil surface to 30 cm depth or more.
...
Other soils that have a [mottled profile form](Diagnostics.qmd#sec-diag-mottpf) and a pH less than 5.5 in some part below 20 cm from the mineral soil surface.
...
1.  a [mottled profile form](Diagnostics.qmd#sec-diag-mottpf), *and*
2.  have [[saline soil materials](Diagnostics.qmd#sec-diag-salt)]{.min} within 60 cm of the mineral soil surface at some time of the year.
...
Other soils that have [[saline soil materials](Diagnostics.qmd#sec-diag-salt)]{.min} within 60 cm of the mineral soil surface at some time of the year.
...
Other soils that have a buried soil, with its upper surface within 60 cm or less from the mineral soil surface that has a B [or BC]{.min} horizon that meets the requirements of [vitric soil material](Diagnostics.qmd#sec-diag-vitr).
...
Other soils that have a buried soil within 60 cm or less from the mineral soil surface to the upper surface of the buried soil, and have a B [or BC]{.min} horizon that meets the requirements of [allophanic soil material](Diagnostics.qmd#sec-diag-alloph), but not necessarily the requirements for bulk density.
...
1.  a [weathered-B horizon](Diagnostics.qmd#sec-diag-bw) with its lower boundary at 30 cm or more from the mineral soil surface, *and*
2.  pH less than 5.5 in some part [between the base of the A horizon and]{.min} within 60 cm of the mineral soil surface.
