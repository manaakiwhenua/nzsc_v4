...
Other soils in which the majority of the gravel is weathered to the extent that coarse rock fragments may easily be broken by hammer or spade, and have an [argillic horizon](Diagnostics.qmd#sec-diag-argh).
...
1.  a [mottled profile form](Diagnostics.qmd#sec-diag-mottpf), *and*
2.  gravel in which the majority is weathered to the extent that coarse rock fragments may easily be broken by hammer or spade.
...
Other soils that have gravel in which the majority is weathered to the extent that coarse rock fragments may easily be broken by hammer or spade.
