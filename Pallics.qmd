...
5.  *Slow permeability.* Subsurface horizons have restricted permeability, particularly in soils with [fragipans](Diagnostics.qmd#sec-diag-fpan) or [duripans](Diagnostics.qmd#sec-diag-dpan) in which the permeability is very slow.
...
10. *Droughty summers, moist winters.* Mean annual precipitation ranges from about 500 to 1,000 mm/yr. A spring surplus of soil water is common, but the annual surplus is less than about 200 mm. The average annual deficit is approximately 90–200 mm/year.
...
table_P_dat <- data.frame(
  ...
  'Example_Series' = c('Pōpōrangi', 'Tokomaru', 'Otokia', 'Nalder', 'Marton', 'Caroline', 'Salix',
                       'Matapiro', '-', 'Matapiro', '-',
                       'Wither', '-', 'Grampians', 'Seaview', 'Cluden', 'Timaru', 'Grampians', 'Takahē', 'Tima',
                       'Pukeuri', '-', 'Otama',
...
Duric Pallic Soils occur in areas with pronounced soil moisture deficits and often have some proportion of tephra in the soil parent material, or high exchangeable sodium. Sufficient silica has been mobilised to form a subsoil pan that impedes roots and water.
...
Argillic Pallic Soils have no [fragipan](Diagnostics.qmd#sec-diag-fpan) or [duric horizon](Diagnostics.qmd#sec-diag-dpan), but have a clay-enriched B horizon in which clay coatings occur predominantly on polyhedral, blocky or prismatic ped surfaces, on coarse rock fragments, or within tubular pores.

#### **PJMY** {#sec-key-PJMY .unnumbered}
...
Immature Pallic Soils that BOTH:
