...
Semiarid Soils are high base status soils in which a soil water deficit prevails over most of the growing season. Wetting fronts [under natural climate conditions]{.min} fail to penetrate deeper than the base of the solum, with consequent accumulation of pedogenic [carbonate]{.min} and [other]{.min} soluble salts.

## Correlation {#sec-cor-S}

The order comprises brown-grey earths, associated steepland soils and intergrades between brown-grey earths and yellow-grey earths and recent soils of the NZ Genetic Soil Classification. [In Soil Taxonomy, the order corresponds with the Aridisols but also with suborders under a xeric moisture regime (Xerepts, Xerults, Xeralfs, Xerorthents).]{.min}
...
5.  *Permeability.* Saturated hydraulic conductivity is slow in soils with [argillic](Diagnostics.qmd#sec-diag-argh) or [cutanic horizons](Diagnostics.qmd#sec-diag-cuth), and in some other silty or fine sandy soils. Infiltration may be reduced by [pugging]{.min}.
...
10. *Erosive.* The soils are susceptible to wind and [water]{.min} erosion.
...
13. *High sodium.* [Particularly in soils with [argillic horizons](Diagnostics.qmd#sec-diag-argh), sodium occupies a large proportion of the cation exchange complex.]{.min}
...
Other soils in which the majority of [rock fragments are weathered to the extent that they]{.min} may easily be broken by hammer or spade.
...
Solonetzic Semiarid Soils have a higher proportion of exchangeable sodium than other Semiarid Soils. This tends to promote the dispersion of clay and organic matter and [establish]{.min} very slow permeability through the clay enriched B horizons.

#### **SZQ** {#sec-key-SZQ}

Solonetzic Semiarid Soils that have [[saline soil materials](Diagnostics.qmd#sec-diag-salt)]{.min} within 60 cm of the mineral soil surface at some time of the year.
...
Soils that have a horizon with[[saline soil materials](Diagnostics.qmd#sec-diag-salt)]{.min} within 60 cm of the mineral soil surface at some time of the year.
