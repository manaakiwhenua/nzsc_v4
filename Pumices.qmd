...
Other soils with a layer of [vitric soil material](Diagnostics.qmd#sec-diag-vitr) with a base at less than 60 cm from the mineral soil surface and within the B or BC horizon, that overlies a layer which fails to meet the requirements of a vitric soil material but meets the requirements of [allophanic soil material](Diagnostics.qmd#sec-diag-alloph) (except bulk density).
